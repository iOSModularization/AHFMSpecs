#
# Be sure to run `pod lib lint AHFMBottomPlayerManager.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/iOSModularization/AHFMBottomPlayerManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ivsall2012' => 'ivsall2012@gmail.com' }
  s.source           = { :git => 'https://github.com/iOSModularization/AHFMBottomPlayerManager.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'AHFMBottomPlayerManager/Classes/**/*'
  
  # s.resource_bundles = {
  #   'AHFMBottomPlayerManager' => ['AHFMBottomPlayerManager/Assets/*.png']
  # }
